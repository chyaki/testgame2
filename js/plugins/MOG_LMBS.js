...
//=============================================================================
/*:
 * @plugindesc (v0.3b) Linear Motion Battle System (LMBS).
 * @author Moghunter
 *
 * @param Turn Duration
 ...
 * @help
 * =============================================================================
 * +++ MOG - Linear Motion Battle System (v0.3 Beta) +++
 * By Moghunter 
...
LMBSwindowSkillList.prototype.update = function() {
    Window_SkillList.prototype.update.call(this);
    if (this._lmbsskillType != $gameTemp._lmbsMenuPhase[2]) {this.refresh()};
};
